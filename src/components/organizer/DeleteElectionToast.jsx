  ...
  return (
    <div>
      ...
      <div onClick={onClose} className="flex gap-2 justify-end mt-4">
        <button className="bg-slate-50 text-slate-700 px-4 py-2 border rounded-sm">
          Cancel
        </button>
        <button onClick={() => handleDeleteElection(electionName)} className="bg-slate-800 text-slate-50 px-4 py-2 rounded-sm">
          Delete
        </button>
      </div>
    </div>
